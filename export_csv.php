...
fputcsv($output, ['ID', 'Nama Pengadu', 'Email Pengadu', 'Kategori Pengaduan', 'Deskripsi', 'Status', 'Tanggal Pengaduan', 'Tanggal Selesai Pengaduan']);

// Query untuk mengambil data dari tabel pengaduan
$query = "SELECT id, nama_pengadu, email_pengadu, kategori_pengaduan, deskripsi, status, tanggal_pengaduan , tanggal_selesai_pengaduan FROM pengaduan";
