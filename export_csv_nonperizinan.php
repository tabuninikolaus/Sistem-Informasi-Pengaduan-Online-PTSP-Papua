...
header('Content-Disposition: attachment; filename=data_Nonperizinan_pengaduan.csv');
...
$query = "SELECT id, nama_pengadu, email_pengadu, kategori_pengaduan, deskripsi, status, tanggal_pengaduan FROM pengaduan  WHERE kategori_pengaduan = 'nonperizinan' 
